...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'account',
                loadChildren: () => __webpack_require__.e(/*! import() | avatar-avatar-module */ "avatar-avatar-module").then(__webpack_require__.bind(null, /*! ../avatar/avatar.module */ "./src/app/pages/avatar/avatar.module.ts")).then(m => m.AvatarPageModule)
            },
            {
                path: 'contact',
                loadChildren: () => __webpack_require__.e(/*! import() | list-list-module */ "list-list-module").then(__webpack_require__.bind(null, /*! ../list/list.module */ "./src/app/pages/list/list.module.ts")).then(m => m.ListPageModule)
            },
            {
                path: 'settings',
                loadChildren: () => __webpack_require__.e(/*! import() | infinite-scroll-infinite-scroll-module */ "infinite-scroll-infinite-scroll-module").then(__webpack_require__.bind(null, /*! ../infinite-scroll/infinite-scroll.module */ "./src/app/pages/infinite-scroll/infinite-scroll.module.ts")).then(m => m.InfiniteScrollPageModule)
            },
        ]
    }
];
